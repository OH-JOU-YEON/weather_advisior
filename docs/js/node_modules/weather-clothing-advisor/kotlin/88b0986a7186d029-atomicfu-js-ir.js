(function (root, factory) {
  ...
  protoOf(AtomicRef).ma = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicRef).na = function () {
  ...
  protoOf(AtomicBoolean).oa = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicBoolean).na = function () {
    return this.kotlinx$atomicfu$value;
  };
  ...
  protoOf(AtomicInt).pa = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicInt).na = function () {
    return this.kotlinx$atomicfu$value;
  };
